# Povzeto in nekoliko posodobljeno po: https://python.plainenglish.io/3d-kinematics-visualisation-25e6b6c53e6c
import os
import numpy as np
import sympy as sp
import pandas as pd
...
class Arrow3D(FancyArrowPatch):
    ...
    def __init__(self, x_,  y_, z_, *args, **kwargs):
        super().__init__((0, 0), (0, 0), *args, **kwargs)
        self._xyz = (x_[0], y_[0], z_[0])
        self._dxdydz = (x_[1], y_[1], z_[1])

    def draw(self, renderer):
        x1, y1, z1 = self._xyz
        x2, y2, z2 = self._dxdydz
...
R = [sp.cos(t), sp.sin(t), sp.sin(2*t)]  # Helix: z=t
